	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-3">
				...
				<h1 class="my-4">
					<a href="/"> <img alt="loopy Books"
						src="/resources/img/loopy Books2.png" width="215" height="80">
					</a>
				</h1>

				<div class="list-group">
					<a href="#" class="list-group-item">IT/인터넷</a> <a href="#"
						class="list-group-item">자기계발</a> <a href="#"
						class="list-group-item">국내외소설</a> <a href="#"
						class="list-group-item">어린이도서</a> <a href="/notice/list"
