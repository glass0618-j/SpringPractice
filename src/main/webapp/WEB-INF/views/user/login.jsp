...
<body class="text-center">
	...
	<main class="form-signin">
		<form action="/user/login_success" method="post">
			...
			<label style="vertical-align: 17px">ID</label> <input type="text"
				id="user_id" name="user_id" class="form-control"
				style="vertical-align: 17px; text-align: right:;"
				placeholder="아이디를 입력하세요" required autofocus><br> <label
				for="inputPw" class="visually-hidden">Password</label> <input
				type="password" id="user_pw" name="user_pw" class="form-control"
